               ...
               <div className="p-6 space-y-6">
                 ...
                 <div className="space-y-2">
                    <div className="flex justify-between items-center text-sm">
                       ...
                       <span className="font-black text-slate-900">{remainFerie} <span className="text-slate-500 font-bold">su {ferieTot}</span></span>
                    </div>
                    ...
                    <p className="text-[10px] uppercase font-black text-slate-500 tracking-wide">Consumate: {usedFerie} giornate</p>
                 </div>
                 ...
                 <div className="space-y-2">
                    <div className="flex justify-between items-center text-sm">
                       ...
                       <span className="font-black text-slate-900">{remain104} <span className="text-slate-500 font-bold">su {p104Tot}</span></span>
                    </div>
                    <div className="h-4 bg-slate-100 rounded-full overflow-hidden">
                    ...
                    <p className="text-[10px] uppercase font-black text-slate-500 tracking-wide">Consumate: {used104} giornate</p>
                 </div>
                 ...
                 <div className="space-y-2">
                    <div className="flex justify-between items-center text-sm">
                       ...
                       <span className="font-black text-slate-900">{festTot - usedFestivita} <span className="text-slate-500 font-bold">su {festTot}</span></span>
                    </div>
                    <div className="h-4 bg-slate-100 rounded-full overflow-hidden">
                    ...
                    <p className="text-[10px] uppercase font-black text-slate-500 tracking-wide">Consumate: {usedFestivita} giornate</p>
                 </div>
               </div>
            </div>
         </div>
                           ...
                           return (
                              <div key={req.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-4 border border-slate-200 rounded-2xl hover:bg-slate-100 transition-colors gap-4">
                                 ...
                                 <div className="text-right shrink-0">
                                    <p className="text-[10px] text-slate-500 uppercase font-black tracking-widest">Inoltrata il</p>
                                    <p className="text-sm font-bold text-slate-700">{new Date(req.createdAt).toLocaleDateString("it-IT")}</p>
                                 </div>
                              </div>
                           )
                        })}

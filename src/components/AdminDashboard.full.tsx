              ...
              <table className="w-full border-collapse text-xs">
                <thead>
                  <tr>
                    ...
                    <th className="px-2 pt-3 pb-1 text-center font-black bg-indigo-50 text-indigo-700 border-b-4 border-l-4 border-indigo-100 min-w-[40px] font-sans text-[9px] uppercase tracking-tighter" rowSpan={2} title="Reperibilit├á nei giorni Festivi e Weekend">
                      FEST
                    </th>
                    <th className="px-2 pt-3 pb-1 text-center font-black bg-slate-50 text-slate-600 border-b-4 border-slate-200 min-w-[40px] font-sans text-[9px] uppercase tracking-tighter" rowSpan={2} title="Reperibilit├á nei giorni Feriali">
                      FER
                    </th>
                    <th 
